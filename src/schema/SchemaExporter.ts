import { DatabaseSchema, TableSchema, ColumnSchema, SchemaExportOptions, DrizzleSchemaOptions } from '../types/index.js';
...
export class SchemaExporter {
  ...
  static exportToDrizzle(
    ...
    options: SchemaExportOptions & DrizzleSchemaOptions = { format: 'drizzle' }
  ): string {
